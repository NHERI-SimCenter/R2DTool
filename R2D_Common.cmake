# R2D_Common.cmake
# Usage:
#   include(path/to/R2D_Common.cmake)
#   simcenter_add_r2d_common(<target>)

set(PATH_TO_COMMON "${CMAKE_CURRENT_LIST_DIR}/../SimCenterCommon")

function(simcenter_add_r2d_common target)


   target_include_directories(${target} PRIVATE
                "${PATH_TO_COMMON}/Workflow/UQ"
 		"${PATH_TO_COMMON}/Workflow/UQ/common"
                "${PATH_TO_COMMON}/Workflow/UQ/dakota"
		"${PATH_TO_COMMON}/Workflow/UQ/simcenterUQ"
		"${PATH_TO_COMMON}/Workflow/UQ/ucsd"
		"${PATH_TO_COMMON}/Workflow/UQ/customUQ"				
    ...
    set(SOURCES
	    "${PATH_TO_COMMON}/Workflow/UQ/dakota/GaussianProcessInputWidget.cpp"
            ...
            "${PATH_TO_COMMON}/Workflow/UQ/ucsd/UCSD_Engine.cpp"
            ...
            "${PATH_TO_COMMON}/Workflow/UQ/UQ_Method.cpp"
            ...
            "${PATH_TO_COMMON}/Workflow/UQ/common/ResultsDataChart.cpp"
	    ...
	    "${PATH_TO_COMMON}/Workflow/WORKFLOW/ModelViewItems/LayerTreeItem.cpp"
            ...
            "${PATH_TO_COMMON}/Workflow/EXECUTION/ModularPython.cpp"
            "${PATH_TO_COMMON}/Workflow/EXECUTION/RunPythonInThread.cpp"
            "${PATH_TO_COMMON}/Workflow/EXECUTION/TapisV3.cpp"
            "${PATH_TO_COMMON}/Workflow/TOOLS/Stampede3Machine.cpp"
            "${PATH_TO_COMMON}/Workflow/TOOLS/TapisMachine.cpp"
	    ...
	    "${PATH_TO_COMMON}/Workflow/EVENTS/SimCenterUnitsCombo.cpp"
    ...
    set(HEADERS
            ...
            "${PATH_TO_COMMON}/Workflow/UQ/UQ_Method.h"	    
            ...
            "${PATH_TO_COMMON}/Workflow/UQ/common/ResultsDataChart.h"	    
	    ...
	    "${PATH_TO_COMMON}/Workflow/WORKFLOW/ModelViewItems/LayerTreeItem.h"
            ...
            "${PATH_TO_COMMON}/Workflow/EXECUTION/RunPythonInThread.h"
            "${PATH_TO_COMMON}/Workflow/EXECUTION/TapisV3.h"	    
            "${PATH_TO_COMMON}/Workflow/TOOLS/Stampede3Machine.h"
            "${PATH_TO_COMMON}/Workflow/TOOLS/TapisMachine.h"	    
