...
QgsFeature* QGISGasPipelineInputWidget::addFeatureToSelectedLayer(QMap<QString, QVariant>& featureAttributes, QgsGeometry& geom)
{
...
QgsVectorLayer* QGISGasPipelineInputWidget::getSelectedFeatureLayer(void)
{
...
QgsVectorLayer *QGISGasPipelineInputWidget::getSelectedFeaturesLayer() const
{
    return selectedFeaturesLayer;
}
...
//Renderer* QGISGasPipelineInputWidget::createPipelineRenderer(void)
//{
